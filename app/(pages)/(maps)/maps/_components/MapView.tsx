...
function buildSOSIcon(): L.DivIcon {
  // Yellow pin with two pulsing rings behind it
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 44" width="32" height="44">
      <filter id="shadow-sos" x="-20%" y="-20%" width="140%" height="140%">
        <feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="rgba(161,128,0,0.5)"/>
      </filter>
      <path
        d="M16 0C7.163 0 0 7.163 0 16c0 11.25 14 28 16 28s16-16.75 16-28C32 7.163 24.837 0 16 0z"
        fill="#eab308"
      ...
      />
      <circle cx="16" cy="16" r="7" fill="white" opacity="0.95"/>
      <text x="16" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="#92400e">!</text>
    </svg>`.trim();
        ...
        >
          <Popup minWidth={200} maxWidth={280} className="map-popup">
            <div className="py-1 space-y-1.5">
              ...
              {m.wasteType && (
                <p className="text-xs text-gray-500 capitalize">{m.wasteType}</p>
              )}
