    ...
    <div className="flex flex-row h-screen overflow-hidden">
      ...
      <div className="lg:w-2/5 w-full flex flex-col items-center bg-white">
        <div className="flex flex-col items-center justify-center lg:justify-between gap-[35px] px-[20px] lg:px-[70px] lg:py-[120px] h-full">
          <div className="flex flex-col text-center lg:text-left gap-[10px] py-[10px]">
          ...
          <div className="flex flex-col items-center w-full lg:w-[330px] gap-[15px]">
            ...
            <Button variant="green" className="w-full h-[60px]">
          ...
          <div className="flex flex-col items-start gap-[15px] w-full lg:w-[330px]">
            <span className="text-background-tertiary font-display-2 font-regular">
              {t("Already have an account?")}
            </span>
            <Button variant="outlined-green" className="h-[60px] w-full">
              <span className="!font-normal !font-display-3 px-2">
                {t("Sign in")}
              </span>
            </Button>
