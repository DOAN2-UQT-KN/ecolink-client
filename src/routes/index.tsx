    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "leaderboard", element: lazyPage(() => import("@/app/(pages)/(main)/leaderboard/page"), "leaderboard") },
          {
            path: "profile",
            ...
            children: [
              ...
              { path: "badges", element: lazyPage(() => import("@/app/(pages)/(main)/profile/badges/page"), "profile-badges") },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "gamification/config", element: lazyPage(() => import("@/app/(pages)/(admin)/admin/gamification/config/page"), "admin-gamification-config") },
