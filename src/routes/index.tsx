    ...
    children: [
      {
        ...
        children: [
          ...
          // Organizations can only be founded through the application pipeline now; the old
          // direct-create page is kept as a redirect so existing links do not break.
          { path: "organizations/create", element: <Navigate to="/organizations/apply" replace /> },
          ...
          { path: "organizations/invitations", element: lazyPage(() => import("@/app/(pages)/(main)/organizations/invitations/page"), "organizations-invitations") },
          { path: "organizations/owner-confirm", element: lazyPage(() => import("@/app/(pages)/(main)/organizations/owner-confirm/page"), "organizations-owner-confirm") },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "activate-account", element: lazyPage(() => import("@/app/(pages)/(auth)/activate-account/page"), "activate-account") },
