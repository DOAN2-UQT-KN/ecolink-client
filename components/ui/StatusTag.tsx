 ...
 */
export function StatusTag({ status, className, isBom, emptyLabel = "—", label }: StatusTagProps) {
  if (status == null) {
    return (
  ...
  return <TagStatus type={status} className={className} isBom={isBom} label={label} />;
}
